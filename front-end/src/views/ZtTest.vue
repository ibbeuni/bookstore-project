    ...
    <div id="productImgAndInformation">
      <div id="productInformationLeft">
        ...
        <div id="productImgDiv" class="left">
          <img id="productImg" class="leftImg" :src="'http://127.0.0.1:3000/img/books/' + item[0].img_cover + '.png'"
            alt="">
          <!-- 放大區 -->
        ...
        <div v-show="rShow" class="right">
          <img :style="r_img" class="rightImg" :src="'http://127.0.0.1:3000/img/books/' + item[0].img_cover + '.png'"
            alt="" />
        </div>
                ...
                <div>
                  <div class="maybeYouLikeImgDiv">
                    <img class="maybeYouLikeImg"
                      :src="('http://127.0.0.1:3000/img/books/' + otherbooks[index].img_cover + '.png')" alt="">
                  </div>
                  <div>
